        ...
        var wordList = ["frog", "moth", "table", "minute", "locker", "planet"];
        ...
        document.onkeypress = function (event) {
            ...
            if ((checkLetter >= 0 && checkLetter < alphabet.length) && (userGuess !== wordLetter0) && (userGuess !== wordLetter1) && (userGuess !== wordLetter2) && (userGuess !== wordLetter3) && (userGuess !== wordLetter4) && (userGuess !== wordLetter5)) {
                ...
                document.getElementById("wrongBoxL").innerHTML = res;*/

                var node = document.createElement("LI");                 // Create a <li> node
                var textnode = document.createTextNode(userGuess);         // Create a text node
                node.appendChild(textnode);                              // Append the text to <li>
                document.getElementById("wrongBoxL").appendChild(node);     // Append <li> to <ul> with id="myList"

                /* function myFunction() {
                     var node = document.createElement("LI");
                     var textnode = document.createTextNode("cake");
                     node.appendChild(textnode);
                     document.getElementById("wrongBoxL").appendChild(node);
                 }*/
                ...
                //    document.getElementById("wrongBoxL").innerHTML = userGuess;
                guesses--;
